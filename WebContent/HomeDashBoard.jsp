            ...
            <ul class="nav" id="side-menu">
              ...
              <li>
                ...
                <ul class="nav nav-second-level collapse">
                  <li>
                    <a href="#"><i class="fa-solid fa-wrench"></i>&nbsp;Plumbing Services</a>
                  </li>
              ...
              <li>
                ...
                <ul class="nav nav-second-level collapse">
                  <li>
                    <a href="index.jsp"><i class="fa-solid fa-user-tie"></i> Admin</a>
                  </li>
                  <li>
              ...
              <li class="dropdown profile_details_drop">
                ...
                >
                  <div class="profile_img">
                   ...
                   <p>  <img src="./resources/images/MyImage1.png" alt="" style="width: 40px; height: 40px; border-radius: 50%;" class="profile_img"/>&nbsp; Jayesh Sonavane</p>
